...
public:
  ...
  static void buildOffset(const CHEdge *edges, size_t edgeSize, size_t nodeSize, NodeId *&offset);
  static void buildOffset(const Edge *edges, size_t edgeSize, size_t nodeSize, std::vector<NodeId> &offset);
