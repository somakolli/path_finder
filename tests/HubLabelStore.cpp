...
TEST(HubLabelStore, StoreAndRetrieveTest) {
  ...
  std::vector<pathFinder::CostNode> vec1 = {pathFinder::CostNode{0, 1, 1}, pathFinder::CostNode{1, 1, 1},
                                            pathFinder::CostNode{2, 1, 1}};
  std::vector<pathFinder::CostNode> vec2 = {pathFinder::CostNode{3, 1, 1}, pathFinder::CostNode{4, 1, 1},
