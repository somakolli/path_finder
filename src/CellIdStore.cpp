...
std::vector<CellId_t> CellIdStore::getCellIds(size_t edgeId) const {
...
size_t CellIdStore::cellIdSize() const { return _cellIdSize; }

size_t CellIdStore::offsetSize() const { return _offsetVectorSize; }
